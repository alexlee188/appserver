...
public class TCPClient {
    ...
    private String mOutbound_message;
    ...
    public void run() {
        ...
        try {
            ...
            socket = (SSLSocket)factory.createSocket(Config.SERVERIP, Config.SERVERPORT);
