...
BEGIN TRANSACTION;
CREATE TABLE JOB (JOB_ID integer primary key autoincrement, CUSTOMER_ID, JOB_DESC text, JOB_NEED_1 varchar(20), JOB_NEED_2 varchar(20), JOB_NEED_3 varchar(20), JOB_START_TIME date, JOB_DURATION real default 1.0, JOB_STATUS varchar(10) default 'open');
