...
BEGIN TRANSACTION;
CREATE TABLE CUSTOMER (CUSTOMER_ID integer, NAME_1 varchar(40), NAME_2 varchar(40), ADDR_BLK_NO varchar(10), ADDR_STREET_1 varchar(80), ADDR_STREET_2 varchar(80), ADDR_CITY varchar(40), ADDR_COUNTRY varchar(40) default "Singapore", PHONE varchar(16), MOBILE varchar(16), ACCOUNT_BAL real default 0.0, ADDR_POSTCODE varchar(10), lastupdatedon date);
